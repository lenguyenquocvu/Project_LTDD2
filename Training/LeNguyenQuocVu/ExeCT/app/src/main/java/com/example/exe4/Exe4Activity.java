...
public class Exe4Activity extends AppCompatActivity implements MediaController.MediaPlayerControl {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SongAdapter songAdapter = new SongAdapter(songList, getLayoutInflater());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuInflater.inflate(R.menu.menu_exe4, menu);
        return true;
