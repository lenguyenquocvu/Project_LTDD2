...
public class MainActivity extends AppCompatActivity implements LocationListener, PlaceSelectionListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            break;
            case R.id.check_satellite: {
                myMap.setMapType(GoogleMap.MAP_TYPE_SATELLITE);
            }
            break;
            case R.id.check_terrain: {
    ...
    public void onPlaceSelected(Place place) {
        ...
        myMap.animateCamera(CameraUpdateFactory.newLatLng(myLatLng));
    }
